...
/**
 * Resize the viewport based on the type of device.
 * Used to manage the bar at the bottom on mobile devices.
 *
 * @param isMobile true for mobile device, else false.
 */
...
/**
 * Load fonts using WebFont google loader.
 */
function loadFonts() {
...
/**
 * Manage bootstrap tabs click.
 * Setup scrollmagic based on the current tab.
 *
...
/**
 * Add interaction to complete scroll the page on down arrow click.
 * Only for desktop devices.
 *
 * @param isMobileDevice true for mobile device, else false.
 */
...
/**
 * Check if eduction tab has been opened.
 *
 * @param tabsOpened
 *
 * @returns boolean education tab status.
 */
...
/**
 * Update the tab status flags.
 *
 * @param tabsOpened the tabs opened status.
 */
...
/**
 * Create a Tween for a timeline element.
 *
 * @param idElement the element to be animated.
 * @param completeFunction function called on animation completion.
 */
...
/**
 * Get the id of the element to trigger in the next timelline animation scroll.
 *
 * @param cssId css id of the current element to trigger the animation.
 * @param index the index of the current element.
 * @param timelineLength the lenght of the timeline.
 * @param timelineElements the timeline elements array.
 *
 * @returns the new id to use in the animation.
 */
...
/**
 * The element in the timeline that triggers an animation.
 *
 * @param controller ScrollMagic controller.
 */
...
/**
 * Show a new bootstrap tab.
 *
 * @param event the event to stop.
 * @param element the element that trigger the show action.
 */
...
/**
 * Check if is education tab.
 *
 * @returns true if this is the education tab, else false.
 */
...
/**
 * Profile elements timeline animation.
 *
 * @param completeFunction function called at the end of the animation.
 */
 ...
 * @param idText css id of the text.
 * @param idImage css id of the image.
 */
...
/**
 * Random sort Who I am icons.
 *
 * @returns random sorted icons.
 */
...
/**
 * Timeline animation Who I am.
 *
 * @param whoIAmIconsRandomed random sorted who i am icons
 * @param idWhoIAmDescription description css id.
 * @param completeFunction animation complete function.
 *
 * @returns Who I am timeline animation.
 */
...
/**
 * Get text and image percentage.
 *
 * @param imagePosition left or right.
 * @returns returns percentages object.
 */
...
/**
 * Create tween animation for images.
 *
 * @param idImage css image id.
 * @param xPercentImage percentage for animation.
 */
...
/**
 * Create tween animation for text.
 *
 * @param idText css text id.
 * @param xPercentText percentage for animation.
 * @param completeFunction animation complete function.
 */
 ...
 *
 * @param controller ScrollMagic controller.
 * @param idElementTrigger css id of the elemtn that triggers the animation.
 * @param tween the Tween animation.
 */
 ...
 *
 * @returns true if it is a mobile device, else false.
 */
...
/**
 * Show threejs rendering surface.
 */
 ...
 *
 * @param completionFunction animation completion function.
 */
 ...
 * Threejs Scene.
 *
 * @param isMobileDevice true if it is a mobile device, else false.
 */
