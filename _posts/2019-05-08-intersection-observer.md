...
{% include blog-lazy-image.html description="The lighthouse audit suggestion to load offscreen images asynchronous only when they are really needed (when they are visible in the viewport)" width="1518" height="193" src="/assets/images/posts/intersection-observer-offscreen-audit.jpg" %}
