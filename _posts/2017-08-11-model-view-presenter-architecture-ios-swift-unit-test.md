...
{% include blog-lazy-image.html description="model view presenter: let's toast to Unit Tests!" width="600" height="400" src="/assets/images/posts/model-view-presenter-ios.jpg" %}
