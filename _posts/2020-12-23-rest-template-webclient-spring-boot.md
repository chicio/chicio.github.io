...
You can find the complete source code of the application described above in this [github repository](https://github.com/chicio/SpringBoot-RestClients-Cheatsheets
 "spring boot resttemplate webclietn cheatsheet").  
