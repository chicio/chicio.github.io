...
Now I was ready to call again the APIs we saw before. To call them there's just one `retrieve` method. To call the different HTTP verbs I just had to customized the request with the correct method:
